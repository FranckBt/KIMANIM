...
class UsersGestionController extends AbstractController
{
    ...
    #[Route('/new', name: 'app_users_gestion_new', methods: ['GET', 'POST'])]
    public function new(Request $request, UsersRepository $usersRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_users_gestion_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('users_gestion/new.html.twig', [
            'user' => $user,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_users_gestion_show', methods: ['GET'])]
    public function show(Users $user): Response
    {
        return $this->render('users_gestion/show.html.twig', [
            'user' => $user,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_users_gestion_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_users_gestion_delete', methods: ['POST'])]
