 ...
 */
final class Version20220512161706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activities_childrens (activities_id INT NOT NULL, childrens_id INT NOT NULL, INDEX IDX_D6DD5CEE2A4DB562 (activities_id), INDEX IDX_D6DD5CEEE84C7936 (childrens_id), PRIMARY KEY(activities_id, childrens_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE activities_childrens ADD CONSTRAINT FK_D6DD5CEE2A4DB562 FOREIGN KEY (activities_id) REFERENCES activities (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE activities_childrens ADD CONSTRAINT FK_D6DD5CEEE84C7936 FOREIGN KEY (childrens_id) REFERENCES childrens (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activities_childrens DROP FOREIGN KEY FK_D6DD5CEE2A4DB562');
        $this->addSql('ALTER TABLE activities_childrens DROP FOREIGN KEY FK_D6DD5CEEE84C7936');
        ...
        $this->addSql('DROP TABLE activities_childrens');
