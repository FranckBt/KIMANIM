 ...
 */
final class Version20220503130449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE childrens (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, additional LONGTEXT DEFAULT NULL, age_range VARCHAR(20) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
